...
import (
	...
	"github.com/fonero-project/fonero-golang/handlers/federation"
...
func main() {
	rootCmd := &cobra.Command{
		Use:   "federation",
		Short: "fonero federation server",
		Long: `
The fonero federation server let's you easily integrate the fonero federation
