...
```bash
$ curl "https://friendbot.fonero.org/?addr=GB7JFK56QXQ4DVJRNPDBXABNG3IVKIXWWJJRJICHRU22Z5R5PI65GAK3"
```
...
var transaction = new FoneroBase.TransactionBuilder(account)
  .addOperation(FoneroBase.Operation.createAccount({
