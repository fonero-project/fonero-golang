...
import (
	...
	"github.com/fonero-project/fonero-golang/protocols/horizon/effects"
)
...
func TestEffectActions_Index(t *testing.T) {
	...
	t.Run("omnibus test", func(t *testing.T) {
		...
		// test streaming, regression for https://github.com/fonero-project/fonero-golang/services/horizon/internal/issues/147
