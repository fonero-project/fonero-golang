...
GOTOP="$( cd "$DIR/../../../../../../../.." && pwd )"
go generate github.com/fonero-project/fonero-golang/services/horizon/internal/db2/schema
...
go generate github.com/fonero-project/fonero-golang/services/horizon/internal/db2/schema
go generate github.com/fonero-project/fonero-golang/services/horizon/internal/test
go install github.com/fonero-project/fonero-golang/services/horizon
