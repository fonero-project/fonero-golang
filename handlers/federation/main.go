// Package federation provides a pluggable handler that satisfies the Fonero
...
type Driver interface {
	...
	// federation request to lookup a `Record` using the provided fonero address.
...
// conform to the Fonero federation protocol.  This handler should be added to
...
type ReverseSQLDriver struct {
	...
	// fonero account id to lookup, such as
