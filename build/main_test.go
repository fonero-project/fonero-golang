...
func TestBuild(t *testing.T) {
	...
	RunSpecs(t, "Package: github.com/fonero-project/fonero-golang/build")
}

// ExampleTransactionBuilder creates and signs a simple transaction, and then
// encodes it into a base64 string capable of being submitted to fonero-core.
//
...
// encodes the transaction into a base64 string capable of being submitted to fonero-core. It uses
...
// being submitted to fonero-core. It uses the transaction builder system.
func ExamplePayment() {
	seed := "SDOTALIMPAM2IV65IOZA7KZL7XWZI5BODFXTRVLIHLQZQCKK57PH5F3H"
	tx, err := Transaction(
		SourceAccount{seed},
