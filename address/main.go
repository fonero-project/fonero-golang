// Package address provides utility functions for working with fonero
// addresses. See https://www.fonero.org/developers/guides/concepts/federation.
// html#fonero-addresses for more on addresses.
package address
