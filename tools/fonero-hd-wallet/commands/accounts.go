...
import (
	...
	"github.com/fonero-project/fonero-golang/exp/crypto/derivation"
...
var AccountsCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		masterKey, err := derivation.DeriveForPath(derivation.FoneroAccountPrefix, seed)
		if err != nil {
		...
		for i := uint32(startID); i < startID+count; i++ {
			...
			println(fmt.Sprintf(derivation.FoneroAccountPathFormat, i), kp.Address(), kp.Seed())
		}
