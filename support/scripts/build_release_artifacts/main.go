...
func build(pkg, dest, version, buildOS, buildArch string) {
	...
	timeFlag := fmt.Sprintf("-X github.com/fonero-project/fonero-golang/support/app.buildTime=%s", buildTime)
	versionFlag := fmt.Sprintf("-X github.com/fonero-project/fonero-golang/support/app.version=%s", version)
...
func repoName() string {
	...
	return "github.com/fonero-project/fonero-golang"
