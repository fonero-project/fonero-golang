...
func TestOptionalFoneroFields(t *testing.T) {
	var val struct {
		F1 string `valid:"fonero_accountid,optional"`
		F2 string `valid:"optional,fonero_accountid"`
		F3 string `valid:"fonero_seed,optional"`
		F4 string `valid:"optional,fonero_accountid"`
	}
