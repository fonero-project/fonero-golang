...
// the format used internally to fonero-core.
//
// fonero-core represents asset "amounts" as 64-bit integers, but to enable
// fractional units of an asset, horizon, the client-libraries and other built
// on top of fonero-core use a convention, encoding amounts as a string of
...
// represented in fonero-core as 1010010000.
package amount
...
// One is the value of one whole unit of currency. Fonero uses 7 fixed digits
...
// Parse parses the provided as a fonero "amount", i.e. a 64-bit signed integer
...
// ParseInt64 parses the provided as a fonero "amount", i.e. a 64-bit signed
...
// IntStringToAmount converts string integer value and converts it to fonero
